...
Доделать:
  ...
  2. classNamePrefix попробовать переделать на передачу типа или как то по другому
    или имя сменить
    или разбить на нужные
    и убрать излишние константы
      OfferTypeFeatureTemplate [OfferTypeFeature.Entire]: ['', ''], //! не могу убрать ошибку TS OfferTypeFeatureTemplate[key] хотя выше проверка - (key in OfferTypeFeatureTemplate)
      и BookmarkButtonIconSize [ClassNamePrefix.Reviews]: { width: 0, height: 0 }, + [ClassNamePrefix.Cities]: { width: 0, height: 0 }
  3. в списках мест сделать опциональные колбеки и перенести все списки на один компонент
  ...
  4. ScrollToTop при переходе по ссылкам в местах неподалеку
