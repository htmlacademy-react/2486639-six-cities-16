...
import { REVIEW_STAR_VALUES } from '../../const';
  ...
  return (
    <form className="reviews__form form" action="#" method="post">
      ...
      <div className="reviews__rating-form form__rating">
        {
          REVIEW_STAR_VALUES.map((item) => {
            const key: string = `${item}-stars`;

            return (
              <React.Fragment key={key} >
                <input className="form__rating-input visually-hidden" name="rating" value={item} id={key} type="radio" />
